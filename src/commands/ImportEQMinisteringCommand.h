...
/// Command that handles EQ ministering PDF import: sets districts, groups, and families.
/// This allows the entire import to be undone as a single operation.
class ImportEQMinisteringCommand : public Command
{
public:
    ImportEQMinisteringCommand(
