    ...
    : QWidget(parent)
{
    ...
    m_medicalView = new EmergencyResourceView(documentManager, ResponseArea::Medical);
    m_subTabs->addTab(m_medicalView, tr("Medical"));

    m_commsView = new EmergencyResourceView(documentManager, ResponseArea::Communications);
    m_subTabs->addTab(m_commsView, tr("Communications"));

    m_recoveryView = new EmergencyResourceView(documentManager, ResponseArea::Recovery);
